...
if(isset($_POST['setuju']))
{
        ...
        $sql = "INSERT INTO tbl_register (`nama`, `username`, `password`, `password2`, `kelas`, `jeniskelamin`)
            VALUES ('$nama', '$username', '$password', '$password2', '$kelas', '$jeniskelamin')";
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        ...
                        <img src="gambar/logo_login.png" alt="logo" width="100" class="shadow-light rounded-circle" >
                        </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="setuju" class="custom-control-input" id="setuju">
                                        <label class="custom-control-label" for="setuju">Saya setuju dengan syarat dan ketentuan
                                        </label>
                                        </div>
                                    </div>
