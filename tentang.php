<html xmlns="http://www.w3.org/1999/xhtml" style="height: auto;"><head>
    <meta charset="utf-8">
    ...
    <link href="http://localhost/perpus1/assets2/css/bootstrap.css" rel="stylesheet">
    <!-- MATERIALIZE -->
    <link href="http://localhost/perpus1/assets2/css/materialize.min.css" rel="stylesheet">
    <!-- FONT AWESOME ICONS  -->
    <link href="http://localhost/perpus1/assets2/css/font-awesome.css" rel="stylesheet">
    <!-- CUSTOM STYLE  -->
    <link href="http://localhost/perpus1/assets2/css/style.css" rel="stylesheet">
    <style>
    .bgg {
        background-image: url('http://localhost/perpus1/assets2/img/1.jpg');
...
<body style="height: auto;">
                ...
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <ul class="right hide-on-med-and-down">
                                ...
                                <li><a class="btn primary" href="login.php">MASUK</a></li>
                            </ul>
                        </div>
                </div>
            </nav>
    ...
    <ul class="sidenav" id="mobile-nav">
        ...
        <li><a class="btn orange" href="login.php">MASUK</a></li>
    </ul>
    <!-- SideNav-end -->
    <!-- Slider -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="gambar/lgsma.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">SELAMAT DATANG DI PERPUSTAKAAN SMAN 3 BLITAR</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="gambar/sma3.jpg" alt="Unsplashed background img 1" style="transform: translate3d(-50%, 944.303px, 0px); opacity: 1;"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper" style="min-height: 784px;">
        ...
        <div class="row">
	<div class="col m 12">
		<h5>Profil Perpustakaan SMAN 3 BLITAR</h5>
	</div>
</div>
...
<div class="row">
	<div class="col m6">
		<div class="card-panel teal darken-2 white-text">
            ...
            Lain hal lagi dengan visi perpustakaan di perguruan tinggi. Perpustakaan di perguruan tinggi memiliki visi yang tidak lepas dari pelaksanaan Tri Dharma Perguruan Tinggi yaitu pendidikan, penelitan dan pengebdian. Perpustakaan di perguruan tinggi dapat difungsikan secara umum sebagai perpustakaan penelitian (research library).
			</p><br>
			<h6><b>Misi</b></h6>
			<li>
    ...
    <div class="col m6">
        <div class="card-panel teal darken-2 white-text">
            ...
            <p>
            1. Tersedianya informasi mutakhir dan agamis bagi civitas akademika secara berkelanjutan.
            2. Terwujudnya pustakawan berkemajuan yang mampu menghadapi tuntutan zaman berlandaskan akhlak, ilmu, dan jiwa profesional.
            3. Terwujudnya pengelolaan perpustakaan yang baik dengan jejaring yang kuat.
            4. Terwujudnya layanan perpustakaan dengan unggulan SMAN 3 BLITAR.
            </p>
        </div>
    </div>
</div>
...
<script src="http://localhost/perpus1/assets/plugins/jQuery/jquery-2.2.3.min.js"></script>
<script type="text/javascript" src="http://localhost/perpus1/assets2/js/materialize.min.js"></script>
<!-- http://localhost/perpus1/assets/bootstrap 3.3.6 -->
<script src="http://localhost/perpus1/assets/bootstrap/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="http://localhost/perpus1/assets/dist/js/app.min.js"></script>
<!--data tables-->
<script src="http://localhost/perpus1/assets/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="http://localhost/perpus1/assets/plugins/datatables/dataTables.bootstrap.min.js"></script>
<script src="http://localhost/perpus1/assets/plugins/datepicker/bootstrap-datepicker.js"></script>
<script src="http://localhost/perpus1/assets/plugins/select2/select2.full.min.js"></script>
<script>
    ...
    </script><div class="sidenav-overlay"></div><div class="drag-target"></div>
<script>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     fixed layout. -->
<!-- SlimScroll -->
<!-- script src="http://localhost/perpus1/assets/plugins/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<!-- <script src="http://localhost/perpus1/assets/plugins/plugins/fastclick/fastclick.js"></script> -->
